...
1. Open a Google Colab notebook or a Jupyter notebook on your laptop. 

- If you are going to set up your own local jupyter notebook environment, please follow this [tutorial](https://towardsdatascience.com/how-to-set-up-anaconda-and-jupyter-notebook-the-right-way-de3b7623ea4a). After setting up the environment, please also install pandas and scikit-learn by:
```
...
- If you are going to use Google Colab as your notebook environment, please read this [tutorial](https://towardsdatascience.com/getting-started-with-google-colab-f2fff97f594c). Please note that you don't have to install the libraries as the second part of the tutorial indicated. Most libraries are pre-installed already.
...
1. This is the link to our [csv file ](https://github.com/CISC-873/Information-2021/releases/download/data/a0.csv)
...
```python
import pandas as pd # we already did but usually people use pd as its abbreviation.
df = pd.read_csv('https://github.com/CISC-873/Information-2021/releases/download/data/a0.csv')
```
